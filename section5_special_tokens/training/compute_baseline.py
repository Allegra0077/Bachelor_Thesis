"""
Compute baseline eval loss (no special tokens) for each persona (Section 4.3).

Evaluates the model's ability to predict user messages from dialogue context
alone, without any learned special tokens. Used as a reference for comparison
with trained special token results.
...
from train_special_tokens import (
